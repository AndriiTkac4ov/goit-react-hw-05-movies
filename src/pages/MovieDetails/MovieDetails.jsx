        ...
        <> {movie &&
            <DetailsSection>
                ...
                <AdditionalWrapper>
                    ...
                    <AdditionalList>
                        <AdditionalItem><AdditionalLink state={{from: location.state?.from}} to='cast'>Cast</AdditionalLink></AdditionalItem>
                        <AdditionalItem><AdditionalLink state={{from: location.state?.from}} to='reviews'>Reviews</AdditionalLink></AdditionalItem>
                    </AdditionalList>
                </AdditionalWrapper>
                <Outlet />
            </DetailsSection>
